...
public class sendsms {
	...
	public int getCheckCode(String phone) {
		...
		NameValuePair[] data = {//提交短信
			    new NameValuePair("account", "C83240029"), //查看用户名请登录用户中心->验证码、通知短信->帐户及签名设置->APIID
			    new NameValuePair("password", "68bf54abe0359488768aa34b8eef177b"),  //查看密码请登录用户中心->验证码、通知短信->帐户及签名设置->APIKEY
