...
%>
<link rel="stylesheet" href="${APP_PATH}/css/group_analysis.css" />
<link rel="stylesheet"
...
<body>
			...
			<div class="col-md-12">
				...
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a
						href="#radar_analysis" aria-controls="home" role="tab"
						data-toggle="tab">雷达图分析</a></li>
				...
				<div class="tab-content row">
					...
					<div role="tabpanel" class="tab-pane active" id="line_analysis">
						...
						<div class="col-md-12">
							<div class="col-md-6">
								<div id="group_analysis_echart01"
					...
					<!-- 第二个 -->
					<div role="tabpanel" class="tab-pane" id="radar_analysis">

						<div class="col-md-12">
							<div class="col-md-6">
								<div id="group_analysis_echart02"
	...
	<script type="text/javascript" src="${APP_PATH}/js/group_analysis.js"></script>
